                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="../actions/admin_proses.php">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../actions/admin_proses.php?aksi=hapus_event&id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin hapus?')"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php endwhile; ?>
                                    </tbody>
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-event-id="<?= $row['event_id'] ?? '' ?>">
                                            ...
                                            <td>
                                                ...
                                                <a href="../actions/admin_proses.php?aksi=hapus_field&id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin hapus?')"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
