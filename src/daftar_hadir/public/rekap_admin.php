...
$fields = [];
$fieldsQuery = "SELECT * FROM form_fields WHERE aktif = 'Y' AND tipe != 'signature' ORDER BY COALESCE(event_id, 0) ASC, urutan ASC, id ASC";
                    ...
                    <form method="GET" class="row g-2">
                        ...
                        <div class="col-md-3">
                            ...
                            <?php if(!empty($filter_event) || !empty($_GET['filter_tgl_awal'])): ?>
                                <a href="../public/rekap.php" class="btn btn-outline-secondary"><i class="fas fa-times"></i></a>
                            <?php endif; ?>
                        </div>
                    </form>
                </div>
            ...
            <div class="row mb-3 no-print">
                ...
                <div class="col-md-4 text-md-end">
                    <div class="btn-group">
                        ...
                        <a href="../actions/export.php?filter_event=<?= $filter_event ?>&filter_tgl_awal=<?= $_GET['filter_tgl_awal'] ?? '' ?>&filter_tgl_akhir=<?= $_GET['filter_tgl_akhir'] ?? '' ?>" class="btn btn-success"><i class="fas fa-file-excel"></i> Export Excel</a>
                        <a href="../actions/export.php?type=csv&filter_event=<?= $filter_event ?>&filter_tgl_awal=<?= $_GET['filter_tgl_awal'] ?? '' ?>&filter_tgl_akhir=<?= $_GET['filter_tgl_akhir'] ?? '' ?>" class="btn btn-warning"><i class="fas fa-file-csv"></i> Export CSV</a>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="../actions/admin_proses.php?aksi=hapus_presensi&id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin hapus data ini?')" title="Hapus"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php 
                            endwhile;
